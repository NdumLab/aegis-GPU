...
window.AEGIS_LEARNING_PARTS.hardware_foundations = {
  ...
  nvlink_fault: {
    ...
    coreTerms: [
      ...
      { term: "XID 149", plain: "A fatal NVLink error on Blackwell-generation GPUs (B100/GB200), reported with subcodes like NETIR_LINK_DOWN — the NVLink5 era's counterpart to XID 74.", why: "The same link-fault family changes its code number on new hardware; an operator who only knows 74 can miss it on a Blackwell fleet." },
      { term: "XID 154", plain: "An informational companion code — the driver stating which recovery action another XID now requires, such as 'GPU Reset Required' or 'Node Reboot Required'.", why: "It is the driver handing you the recovery plan directly; read its guidance instead of guessing from the primary code." },
