...
3. Installs repo nginx and systemd files, reloads systemd, validates nginx, and restarts `nginx` and `aegis-gpu`.
...
- `python3 -m unittest /home/henry/aegis-gpu/frontend/tests/test_frontend_smoke.py -v`
