...
class FrontendSmokeTest(unittest.TestCase):
    ...
    def test_beginner_mode_controls_and_learning_module_exist(self):
        ...
        self.assertIn('btn-toggle-coach', INDEX)
        self.assertIn('btn-close-coach', INDEX)
        ...
        self.assertIn('toggleLabCoach', APP_JS)
        self.assertIn('gpusim_lab_coach_open', APP_JS)
        ...
        self.assertIn('lab-step-coach-section-title', APP_JS)
        self.assertIn('What To Look For', APP_JS)
