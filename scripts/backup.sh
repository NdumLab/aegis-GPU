...
copy_tree /etc/nginx/conf.d/aegis-domain.conf "${DEST}/etc/nginx/conf.d/aegis-domain.conf"
copy_tree /etc/ssl/certs/aegis-gpu.crt "${DEST}/etc/ssl/certs/aegis-gpu.crt"
copy_tree /etc/ssl/private/aegis-gpu.key "${DEST}/etc/ssl/private/aegis-gpu.key"
